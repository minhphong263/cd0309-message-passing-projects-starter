...
6. `kubectl apply -f deployment/udaconnect-connection-service.yaml` - Set up the connection service and deployment for the web app
7. `kubectl apply -f deployment/udaconnect-person-service.yaml` - Set up the person service and deployment for the web app
8. `kubectl apply -f deployment/udaconnect-location-consumer.yaml` - Set up the location consumner and deployment for massage processing
9. `kubectl apply -f deployment/udaconnect-location-producer.yaml` - Set up the location producer and deployment for massage processing
10. `kubectl apply -f deployment/udaconnect-kafka.yaml` - Set up the kafka service and zookeeper service and deployment for massage processing
